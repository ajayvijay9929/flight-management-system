                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-8 form-container">
                            <h3 class="text-center form-title">Delete Flight Details</h3>
                            <form:form action="/deleteflight" method="post" modelAttribute="flightRecord">
                                ...
                                <div class="form-group">
                                    ...
                                    <form:input path="departure" class="form-control" id="departure" disabled="true" />
                                </div>
                                <div class="form-group">
                                    <label for="arrival">Enter Arrival Time:</label>
                                    <form:input path="arrival" class="form-control" id="arrival" disabled="true" />
                                </div>
                                <form:hidden path="seatBooked" />
